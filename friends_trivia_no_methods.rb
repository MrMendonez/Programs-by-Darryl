...
puts ( "(Press return to continue.)" )
anyKey = gets.chomp
puts ( "You only get 2 chances to get the question right, otherwise you lose the game.")
puts ( "(Press return to continue.)" )
anyKey = gets.chomp
...
#Question 1
puts ( "Question 1: Which band does Monica, Chandler, and Ross go to see for Ross' birthday?")
sleep(4)
puts ( "a: Van Halen" )
sleep(2)
...
while tries < 2 																		# ask Ken about move_on variable
	...
	tries += 1
	if response == answer
		puts ( "\nThat is correct!\n\n" )													# add a \n in the front of That is correct!
		sleep(2)
		tries = 2
	elsif tries == 2
		puts ( "Sorry, that is also incorrect!" )
		sleep(2)
		puts ( "You lost the game!" )
		sleep(2)
		puts ( "\nWould you like to know the correct answer? (y/n)" )
	  	like_to_know = gets.chomp
	  	if like_to_know == "y" or like_to_know == "yes"									# add downsize to "yes"
	  		puts ( "The correct answer is " + full_answer + "!" )
	  		sleep(2)
	  		puts ( "Better luck next time!" )
	  		sleep(2)																	# ask user if they would like to replay the game
	  		puts ( "Game Over" )														# figure out how to restart game without exiting program
	  		sleep(2)
	  		exit
	  	else
	  		puts ( "Better luck next time!" )
...
#Question 3
puts ( "Question 3: Where does Phoebe's Scientist boyfriend David leave here to go work?" )
sleep(4)
puts ( "a: Australia" )
sleep(2)
full_answer = "b: Minsk"
...
#Question 6
puts ( "Question 6: In Monica's fat days, what made her want to loose all her weight?" )
sleep(4)
...
sleep(2)
full_answer = ( "d: The duck swallowed it" )
puts ( full_answer )
sleep(2)
puts ( "(a/b/c/d)" )
